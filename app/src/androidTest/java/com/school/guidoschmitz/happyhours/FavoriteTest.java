...
public class FavoriteTest extends AndroidTestCase {
    ...
    public void testFavoriteLocation() {
        ...
        UserRepository.removeFavorites();
    ...
    public void testRemoveFavorites() {
        ...
        UserRepository.addFavorite(location1);
        UserRepository.addFavorite(location3);

        UserRepository.removeFavorites();
        ArrayList<Location> favorites = UserRepository.getFavorites();
